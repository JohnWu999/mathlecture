  ...
  return (
    <main className="forest-home">
      ...
      <style jsx global>{`
        ...
        .forest-home{position:relative;min-height:100vh;margin:0;color:var(--green);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","Noto Sans SC","PingFang SC","Microsoft YaHei",sans-serif;background:var(--paper);overflow-x:hidden}
        .forest-home::before{content:"";position:fixed;inset:0;z-index:-2;background:radial-gradient(circle at 12% 10%,rgba(255,209,102,.42),transparent 25%),radial-gradient(circle at 88% 16%,rgba(139,216,111,.32),transparent 28%),linear-gradient(180deg,#fff8e8 0%,#fffdf3 42%,#eef9e8 100%)}
        .forest-home::after{content:"";position:fixed;inset:0;z-index:-1;background-image:linear-gradient(rgba(24,70,56,.032) 1px,transparent 1px),linear-gradient(90deg,rgba(24,70,56,.032) 1px,transparent 1px);background-size:34px 34px;mask-image:linear-gradient(to bottom,#000 0%,rgba(0,0,0,.52) 58%,transparent 100%)}
        ...
        @media(max-width:620px){.brand span{font-size:16px}.brand svg{width:46px}.navlinks .ask{display:none}.test-ribbon{align-items:flex-start;justify-content:flex-start;font-size:12px;padding:9px 14px}.test-ribbon span{line-height:1.45}.hero{min-height:auto;padding:clamp(22px,6vw,30px) 14px 34px;overflow:visible}.hero-grid{display:grid;grid-template-columns:minmax(0,1fr);gap:20px;max-width:100%}.hero-copy{min-width:0}h1{font-size:clamp(32px,10.4vw,40px);line-height:1.08;letter-spacing:-.055em;max-width:100%;overflow-wrap:anywhere}.hi{white-space:normal;display:inline}.hi:after{left:-4px;right:-4px;bottom:3px;height:.46em}.lead{font-size:16px;line-height:1.62;max-width:100%}.world{width:100%;max-width:100%;height:clamp(430px,118vw,520px);border-radius:30px;overflow:hidden}.path-svg{width:620px;max-width:145%;top:44%}.stage{width:142px;transform:scale(.66);transform-origin:center}.stage.seed{left:-18px;top:205px}.stage.teacher{left:50%;top:72px;transform:translateX(-50%) scale(.66)}.stage.forest{right:-18px;top:205px}.question-card{left:12px;right:12px;bottom:24px;max-width:calc(100% - 24px);padding:14px;border-radius:24px}.question-card .top{align-items:flex-start;flex-direction:column;gap:7px}.question-card h3{font-size:17px}.warm-note{display:none}.section{padding-top:58px;padding-bottom:58px}.section h2,.warm-panel h2{font-size:34px}.project-board{display:block}.mission{min-height:auto;margin-bottom:18px}.mission h3{font-size:30px}.mission .slots{grid-template-columns:1fr}.poster{padding-left:78px}.forest-nav{height:68px}.scroll-cue{display:none}.tiny-story{flex-wrap:wrap}.buttons .btn,.final-buttons .btn{width:100%}}
